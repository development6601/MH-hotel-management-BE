...
export const bookRoom = async (req, res) => {
    ...
    const finalrequestedCheckInDate = new Date(requestedCheckInDate);
    finalrequestedCheckInDate.setDate(requestedCheckInDate.getDate() + 1);
    
    const finalrequestedCheckOutDate = new Date(requestedCheckOutDate);
    finalrequestedCheckOutDate.setDate(requestedCheckOutDate.getDate() + 1);
    
    // console.log(finalrequestedCheckInDate);
    // console.log(finalrequestedCheckOutDate);
